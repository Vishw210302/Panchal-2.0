...
const DirectoryScreen = ({ navigation }) => {
    ...
    const renderMemberCard = ({ item }) => (
        <TouchableOpacity style={styles.memberCard} onPress={() => handleUserDetailsPage(item)} activeOpacity={0.7}>
            ...
            <View style={styles.header}>
                <View style={styles.headerContent}>
                    ...
                    <View style={styles.headerTextContainer}>
                        <Text style={styles.headerTitle}>Panchal Samaj Members</Text>
                    </View>
                </View>
            </View>
            ...
            <View style={styles.listContainer}>
                {filteredMembers.length > 0 ? (
                    <FlatList
                        ...
                        keyExtractor={(item) => item._id || item.personal_id || Math.random().toString()}
                    ...
                    <View style={styles.emptyContainer}>
                        ...
                        <Text style={styles.emptyText}>
                            {memberListing.length === 0 ? 'Loading members...' : 'No members found'}
                        </Text>
