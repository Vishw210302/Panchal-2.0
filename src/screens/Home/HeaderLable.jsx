                ...
                <View style={styles.headerContent}>
                    ...
                    <View style={styles.rightSection}>
                        ...
                        >
                            <Image
                                source={{
                                    uri: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80",
                                }}
                                style={styles.profileImage}
                                defaultSource={{ uri: 'https://via.placeholder.com/44x44/cccccc/ffffff?text=U' }}
                            />
                        </TouchableOpacity>
                    </View>
                </View>
                    ...
                    <View style={styles.modalContent}>
                        ...
                        <View style={styles.profileInfo}>
                            <Image
                                ...
                                defaultSource={{ uri: 'https://via.placeholder.com/100x100/cccccc/ffffff?text=U' }}
                            />
                        ...
                        <View style={styles.optionsContainer}>
                            {profileOptions.map((item, idx) => (
                                ...
                                >
                                    ...
                                    />
                                    <Text
                                        style={item.danger ? styles.optionTextDanger : styles.optionText}
                                    >
                                        {item.text}
                                    </Text>
                                    <IconComponent
